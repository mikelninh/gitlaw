...
export const legalScenarios: LegalScenario[] = [
  {
    ...
    category: 'Arbeit',
    terms: ['arbeitgeber hat mir gekündigt', 'arbeitgeber hat gekuendigt', 'chef hat mich gekündigt', 'chef hat mich gekuendigt', 'kündigung im job', 'kuendigung im job', 'arbeitsplatz gekündigt', 'arbeitsplatz gekuendigt'],
  ...
  },
  {
    ...
    terms: ['jobcenter hat abgelehnt', 'jobcenter lehnt ab', 'bürgergeld abgelehnt', 'buergergeld abgelehnt', 'bescheid vom jobcenter', 'widerspruch jobcenter', 'sozialleistung abgelehnt', 'grundsicherung abgelehnt'],
  ...
  },
  {
    ...
    terms: ['online beleidigt', 'im internet beleidigt', 'auf instagram beleidigt', 'auf tiktok beleidigt', 'online bedroht', 'im internet bedroht', 'hassnachricht', 'drohnachricht'],
  ...
  },
  {
    ...
    category: 'Gesundheit',
    terms: ['krankenkasse übernimmt nicht', 'krankenkasse uebernimmt nicht', 'medikament abgelehnt', 'behandlung abgelehnt', 'krankenkasse zahlt nicht', 'rezept zu teuer'],
  ...
  },
  {
    ...
    category: 'Familie',
    terms: ['elternzeit beantragen', 'elternzeit nehmen', 'arbeitgeber lehnt elternzeit', 'elternzeit abgelehnt', 'nach der geburt zuhause bleiben', 'nach der geburt zu hause bleiben'],
