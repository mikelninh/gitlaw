...
(1) Eine Verbandsklage ist nur zulässig, wenn die klageberechtigte Stelle nachvollziehbar darlegt, dass Im Fall des § 7 Absatz 1 ist die Gesamtzahl der von der gemeinschaftlichen Klage betroffenen Verbraucher maßgeblich.
...
(1) Die klageberechtigte Stelle ist verpflichtet, auf ihrer Internetseite zu informieren über: Auf der Internetseite ist ferner darüber zu informieren, dass Verbraucher nur dann von den Wirkungen einer Verbandsklage erfasst werden, wenn sie Ansprüche oder Rechtsverhältnisse, die Gegenstand der Verbandsklage sind, zur Eintragung in das Verbandsklageregister anmelden.
...
(4) Im Fall des Absatzes 1 Satz 1 entscheidet das Gericht durch Urteil, wenn In diesem Fall enthält die Urteilsformel die Angaben nach Absatz 2 und § 18 Absatz 1; § 18 Absatz 2 und 3 ist entsprechend anzuwenden.
...
Der Sachwalter hat dem Gericht bei Beendigung seines Amtes Schlussrechnung zu legen. Die Rechnung einschließlich der Belege muss spätestens einen Monat nach Beendigung des Umsetzungsverfahrens Das Gericht benachrichtigt den Unternehmer unverzüglich vom Eingang der Schlussrechnung. Der Unternehmer ist berechtigt, Einwendungen gegen die Schlussrechnung zu erheben. Soweit binnen zwei Wochen nach der Benachrichtigung keine Einwendungen erhoben werden, gilt die Rechnung als anerkannt.
...
(1) Das Gericht stellt die Beendigung des Umsetzungsverfahrens fest. Der Beschluss enthält: Der Beschluss steht hinsichtlich seiner Vollstreckbarkeit einem Kostenfestsetzungsbeschluss gleich.
...
(2) Die Anmeldung ist nur wirksam, wenn sie frist- und formgerecht erfolgt und folgende Angaben enthält: Wird ein Zahlungsanspruch angemeldet, so soll die Anmeldung auch Angaben zur Höhe dieses Anspruchs enthalten.
