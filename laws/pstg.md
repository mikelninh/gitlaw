...
## Abschnitt 2: Fortführung des Sterberegisters;
Todeserklärungen
...
3. Erklärung, durch die ein verwitweter oder geschiedener Ehegatte a)seinen Geburtsnamen wieder annimmt,b)den bis zur Bestimmung des Ehenamens geführten Namen wieder annimmt oderc)dem Ehenamen seinen Geburtsnamen oder den bis zur Erklärung über die Bestimmung des Ehenamens geführten Namen voranstellt oder anfügt oder diese Erklärung widerruft, seinen Geburtsnamen wieder annimmt, den bis zur Bestimmung des Ehenamens geführten Namen wieder annimmt oder dem Ehenamen seinen Geburtsnamen oder den bis zur Erklärung über die Bestimmung des Ehenamens geführten Namen voranstellt oder anfügt oder diese Erklärung widerruft,
...
3. die Anforderungen an elektronische Verfahrena)zur Führung der Personenstandsregister und Sicherungsregister sowie die Aufbewahrung dieser Register einschließlich der Anforderungen an Anlagen und Programme sowie deren Sicherung (§§ 3, 4),b)mittels derer die Identität der Person, die die Eintragung vorgenommen hat, erkennbar ist (§ 3 Abs. 2 Satz 3), zur Führung der Personenstandsregister und Sicherungsregister sowie die Aufbewahrung dieser Register einschließlich der Anforderungen an Anlagen und Programme sowie deren Sicherung (§§ 3, 4), mittels derer die Identität der Person, die die Eintragung vorgenommen hat, erkennbar ist (§ 3 Abs. 2 Satz 3),
